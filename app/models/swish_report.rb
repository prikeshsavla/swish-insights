class SwishReport < ApplicationRecord
  ...
  def calculate_swish_score
    self.swish_score = (accessibility + performance + seo + best_practices + (400 - (first_contentful_paint + first_meaningful_paint + time_to_interactive + speed_index))).to_f.round(2)
  end
